  ...
  <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6 mb-4">
    ...
    <section class="py-3">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <h3 class="mb-5">DEPORTES</h3>
          </div>
        </div>
        
        <div class="row">
        <?php foreach($this->modelo->ListarDeportes() as $r):?>
          <div class="col-lg-3 col-sm-6">
            <div class="card card-plain">
              ...
              <div class="card-body px-0">
                ...
                <a href="?c=noticia&a=VerNoticia" class="text-info text-sm icon-move-right">Read More
            ...
            <div class="card card-blog card-background cursor-pointer">
              ...
              <div class="card-body">
                <div class="content-left text-start my-auto py-4">
                  ...
                  <a href="?c=noticia&a=VerNoticia" class="text-white text-sm icon-move-right">Ver noticia
                    <i class="fas fa-arrow-right text-xs ms-1"></i>
                  </a>
                </div>
              </div>
